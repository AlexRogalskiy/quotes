...
LABEL io.nullables.quotes.name="quotes"
LABEL io.nullables.quotes.description="Styled quotes"
LABEL io.nullables.quotes.url="https://nullables.io/"
LABEL io.nullables.quotes.vcs-ref=$VCS_REF
LABEL io.nullables.quotes.vcs-url="https://github.com/AlexRogalskiy/quotes"
